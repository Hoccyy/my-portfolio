      ...
      <div className={styles.primary}>
        ...
        <div className={styles.expSection}>
          <div className={styles.expCenter}>
            ...
            <ExperienceItem companyLink='https://www.yorku.ca' jobTitle='Sophomore Year Student' companyName='York University' companyLogoSrc='/york2.png' technologies={['Java', 'JavaScript' , 'TypeScript' , 'React', 'C', 'Software Tools', 'Shell Scripting', 'Unix' , 'CSS', 'Junit', 'Linux' , 'HTML' , 'Algorithms' , 'Calculus I', 'Calculus II' , 'Discrete Math', 'Theory of Computation', 'Data Structures' ]} duties={['Computer Science Hons. BA', '2023 - Present' ]} jobDesc='Coursework' imageIncluded={true} />
